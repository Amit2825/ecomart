...
<h2 class="text-center fw-bold mb-4">Chat with us</h2>
<iframe src='https://webchat.botframework.com/embed/chat-language12-bot?s=Q31tlfNKL20.eZlZJ7YwyPaKar7co1eg-k-9WgBtj_udO7j-5nEe8AI'  style='min-width: 400px; width: 100%; min-height: 500px;'></iframe>
</body>
<footer>
    <section id="foot">
        <div class="foot">
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-section">
                <h3>Contact Us</h3>
                <p>Email: baijnath662004@gmail.com</p>
                <p>Phone: 9120346101</p>
            </div>
            <div class="footer-section">
                <h3>Follow Us</h3>
        ...
        <div class="footer-bottom">
            <p class="copyright">Copyright &copy; 2024 baijnath prajapati</p>
        </div>
    </footer>
